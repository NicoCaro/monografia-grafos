...
% Text Node
\draw (124,185) node [scale=1]  {$v_{1}$};
% Text Node
\draw (162,218) node [scale=1]  {$e_{1}$};
% Text Node
\draw (202,185) node [scale=1]  {$v_{2}$};
% Text Node
\draw (240,218) node [scale=1]  {$e_{2}$};
% Text Node
\draw (280,185) node [scale=1]  {$v_{3}$};
% Text Node
